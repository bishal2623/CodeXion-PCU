...
$query=mysqli_query($con,"SELECT * FROM users WHERE userEmail='$userEmail' and contact='$contact'");
$num=mysqli_fetch_array($query);
if($num>0)
{
mysqli_query($con,"update users set password='$password' WHERE userEmail='$userEmail' and contact='$contact' ");
$msg="Password Changed Successfully";

}
else
{
$errormsg="Invalid userEmail id or Contact no";
}
}
?>
...
return true;
  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container" style="background-color:#f0f8220">
	  		<h3 align="center"style="color:#f0f8ff;font-size:50px; color:white f0f8ff" >Student Grievances</h3>
	<hr />
...
<input type="userEmail" name="userEmail" placeholder="userEmail" autocomplete="off" class="form-control" required><br >
