...
$branch=$_POST['branch'];
$query=mysqli_query($con,"update users set fullName='$fname',contactNo='$contactno',university='$university',college='$college',prn='$prn',branch='$branch' where userEmail='".$_SESSION['login']."'");
if($query)
{
