...
if(isset($_POST['submit']))
{
	...
	$status=1;
	$query=mysqli_query($con,"insert into users(fullName,email,password,contact,status) values('$fullname','$email','$password','$contact','$status')");
...
<html lang="en">
  <head>
    ...
    <title>SGS | Student Registration</title>
...
error:function (){}
  ...
  <body>
	  <div id="login-page">
	  	<div class="container">
	<h3 align="center" style="color:#fff">Student Grievance System</h3>
	<hr />
