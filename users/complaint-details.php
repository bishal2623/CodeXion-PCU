...
<html lang="en">
  <head>
    ...
    <title>SGSS | Complaint Details</title>
...
<div class="progress">
    <ul>
      ...
      <li> <i class="fa fa-check"></i><p>College Level</p> </li>
      <li><i class="fa fa-refresh"></i><p>University Level</p> </li>
      <li><i class="fa fa-times"></i><p>SGSS Committee</p> </li>
    </ul>
